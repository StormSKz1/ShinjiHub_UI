...
if not isfolder("Shijin")then
	makefolder("Shijin");
end;
if not isfolder("Shijin/themes")then
	makefolder("Shijin/themes");
end;
local ThemeManager = {} do
	ThemeManager.Folder = 'Shijin/themes'
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Shijin Hub'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"000000","AccentColor":"ff0000","BackgroundColor":"070606","OutlineColor":"292525"}') },
